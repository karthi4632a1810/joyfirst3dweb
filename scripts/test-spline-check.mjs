...
const WAYPOINTS = [
  { s: 0.00, p: [14.0, 7.5, 26.0], t: [0.0, 3.2, 0.0] },
  { s: 0.07, p: [6.5, 4.6, 19.0], t: [-0.8, 3.0, 4.0] },
  { s: 0.13, p: [0.6, 2.6, 13.5], t: [-1.4, 2.2, 6.0] },
  { s: 0.19, p: [-1.4, 1.75, 8.6], t: [-1.4, 1.75, 4.5] },
  { s: 0.215, p: [-1.4, 1.65, 6.70], t: [-1.4, 1.62, 3.2] },
  { s: 0.24, p: [-1.4, 1.62, 5.80], t: [-1.4, 1.62, 3.0] }, // Door O1
  { s: 0.28, p: [-1.4, 1.62, 4.60], t: [-2.6, 1.60, 3.4] },
  { s: 0.31, p: [-1.2, 1.62, 4.18], t: [-4.2, 1.45, 4.3] },
  { s: 0.34, p: [-0.5, 1.62, 4.15], t: [1.6, 1.90, 2.2] },
  { s: 0.36, p: [0.2, 1.62, 4.10], t: [2.5, 1.75, 2.8] },
  { s: 0.37, p: [0.60, 1.62, 4.40], t: [3.4, 1.70, 3.0] },
  { s: 0.38, p: [0.60, 1.62, 3.60], t: [3.4, 1.70, 3.0] }, // Portal O2
  { s: 0.395, p: [0.60, 1.62, 2.70], t: [3.4, 1.70, 2.7] }, // O2 square-off
  { s: 0.41, p: [3.6, 1.62, 2.70], t: [5.6, 1.60, 2.4] },
  { s: 0.43, p: [4.1, 1.62, 2.00], t: [6.4, 1.58, 1.6] },
  { s: 0.45, p: [4.80, 1.62, 2.00], t: [7.0, 1.55, 1.2] }, // Portal O3
  { s: 0.49, p: [6.4, 1.62, 1.20], t: [8.2, 1.40, -0.4] },
  { s: 0.53, p: [7.1, 1.62, -0.60], t: [7.4, 1.95, -3.2] },
  { s: 0.57, p: [7.2, 1.62, -2.40], t: [6.2, 1.85, -4.6] },
  { s: 0.61, p: [6.6, 1.62, -4.00], t: [5.0, 1.30, -5.0] },
  { s: 0.63, p: [5.6, 1.62, -2.60], t: [4.2, 1.58, -3.4] },
  { s: 0.65, p: [4.80, 1.62, -2.60], t: [3.4, 1.60, -4.4] }, // Portal O5
  { s: 0.68, p: [4.0, 1.62, -3.00], t: [2.8, 1.55, -4.8] },
  { s: 0.695, p: [3.60, 1.62, -2.85], t: [3.0, 1.52, -4.8] },
  { s: 0.71, p: [3.60, 1.62, -3.60], t: [2.4, 1.50, -4.9] }, // Door O6
  { s: 0.725, p: [3.20, 1.62, -4.30], t: [1.8, 1.40, -4.9] },
  { s: 0.74, p: [2.6, 1.62, -4.50], t: [1.2, 1.30, -4.9] },
  { s: 0.755, p: [1.20, 1.62, -4.35], t: [0.4, 1.50, -3.8] },
  { s: 0.77, p: [1.20, 1.62, -3.60], t: [-0.6, 1.60, -3.2] }, // Door O7
  { s: 0.78, p: [0.6, 1.62, -3.00], t: [-1.0, 1.60, -3.8] },
  { s: 0.79, p: [0.0, 1.62, -3.00], t: [-1.2, 1.60, -4.3] },
  { s: 0.80, p: [-1.00, 1.62, -2.85], t: [-1.8, 1.50, -4.6] },
  { s: 0.81, p: [-1.00, 1.62, -3.60], t: [-2.4, 1.45, -4.9] }, // Door O8
  { s: 0.83, p: [-1.9, 1.62, -4.40], t: [-3.4, 1.35, -5.0] },
  { s: 0.84, p: [-3.60, 1.62, -4.35], t: [-4.2, 1.50, -3.6] },
  { s: 0.85, p: [-3.60, 1.62, -3.60], t: [-4.6, 1.60, -3.2] }, // Door O9
  { s: 0.86, p: [-4.2, 1.62, -3.00], t: [-5.6, 1.55, -3.4] },
  { s: 0.87, p: [-4.80, 1.62, -3.00], t: [-6.6, 1.50, -4.2] }, // Portal O10
  { s: 0.89, p: [-6.4, 1.62, -3.20], t: [-8.4, 1.35, -4.4] },
  { s: 0.91, p: [-7.2, 1.62, -1.60], t: [-8.4, 1.25, 0.2] },
  { s: 0.93, p: [-7.4, 1.62, 0.20], t: [-8.6, 1.20, 1.6] },
  { s: 0.95, p: [-7.2, 1.62, 2.20], t: [-8.4, 1.00, 4.0] },
  { s: 0.96, p: [-6.4, 1.62, 3.40], t: [-5.0, 1.70, 2.2] },
  { s: 0.965, p: [-5.4, 1.62, 2.60], t: [-4.2, 1.75, 2.2] },
  { s: 0.97, p: [-4.80, 1.62, 2.60], t: [-3.2, 2.20, 1.2] }, // Portal O13
  { s: 0.975, p: [-3.40, 1.62, 0.60], t: [-1.4, 2.60, 0.0] },
  { s: 0.98, p: [-2.60, 1.62, 0.60], t: [-0.6, 3.20, -0.2] }, // Portal O14
  { s: 1.00, p: [-0.7, 1.65, 0.90], t: [1.9, 3.90, -1.1] }, // Finale
];

function sampleWaypointCurve(scroll) {
  let idx = 0;
  while (idx < WAYPOINTS.length - 2 && WAYPOINTS[idx + 1].s <= scroll) {
    idx++;
  }
  ...
  const localT = Math.max(0, Math.min(1, (scroll - w1.s) / span));
...
const wallDefs = [
  ...
  // North meeting room: O7 at x=1.20, O6 at x=3.60
  ...
  // North exec: O9 at x=-3.60, O8 at x=-1.00
  ...
  // West wall: O10 at z=-3.0, O11/O12 at z=-1.2..1.4, O13 at z=2.60
...
for (let i = 0; i <= 4000; i++) {
  ...
  for (const d of DIRS) {
    ...
    if (hits.length > 0 && hits[0].distance < R) {
      proxFailures++;
      if (proxFailures <= 5) {
        console.log(`Prox fail at t=${t.toFixed(4)} p=${p.x.toFixed(2)},${p.y.toFixed(2)},${p.z.toFixed(2)} dist=${hits[0].distance.toFixed(3)} obj=${hits[0].object.name}`);
      }
      break;
    }
  }
  ...
  if (i < 4000) {
    const q = sampleWaypointCurve((i + 1) / 4000);
...
console.log(`Results: proxFailures=${proxFailures}, tunnelFailures=${tunnelFailures}, heightFailures=${heightFailures}`);
