  ...
  return (
    ...
    >
      <div className="container-arch">
        ...
        <div className="mt-[clamp(3rem,8vh,5rem)] flex flex-col gap-10 md:flex-row md:items-end md:justify-between">
          <Reveal delay={0.1}>
          ...
          <Reveal delay={0.16}>
            <div className="flex flex-col gap-3 md:items-end">
              <a
                ...
                data-cursor="hover"
                className="text-[clamp(1.125rem,2vw,1.5rem)] tracking-[-0.01em] text-graphite transition-colors duration-500 hover:text-bronze"
              >
                {site.contact.phone}
              </a>
              <a
